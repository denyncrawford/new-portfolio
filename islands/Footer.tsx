...
export const Footer = ( { darkModeSignal }: { darkModeSignal: Signal<"light" | "dark"> } ) => {
  ...
  return (
    ...
    <a class="mt-5 mx-auto" href="https://fresh.deno.dev">
          <img
            width="156"
            height="30"
            src={ darkModeSignal.value === 'dark' ? "https://fresh.deno.dev/fresh-badge-dark.svg" : "https://fresh.deno.dev/fresh-badge.svg"}
            alt="Made with Fresh"
          />
        </a>
  </div>
